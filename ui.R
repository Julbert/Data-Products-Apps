...
shinyUI(
  navbarPage("Shiny Application - Part 1 Peer Assignment",
             tabPanel("Analysis",
                      fluidPage(
             ...
             tabPanel("Check the Source Code",
                      h2("All the Source code can be find in Coursera modules"),
                      hr(),
             ...
             tabPanel("Go back to my Github repository",
                      a("https://github.com/julbert"),
                      hr(),
                      h2("I hope you like this Shiny App"),
                      h3("The name of the repositorie is Data Products Apps")
             )
  )
)